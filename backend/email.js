...
const BRAND = {
  ...
  text: '#374151',
  muted: '#6B7280',
  site: process.env.WEBSITE_URL || 'https://Haven Homes.vercel.app',
...
<div style="max-width:600px;margin:0 auto;font-family:'Helvetica Neue',Arial,sans-serif;color:${BRAND.text};line-height:1.7;background:${BRAND.bg};border-radius:12px;overflow:hidden;border:1px solid ${BRAND.border};">
  ...
  <div style="background:${BRAND.dark};padding:32px 28px;text-align:center;">
    ...
    <p style="margin:8px 0 0;font-size:13px;color:rgba(255,255,255,0.7);">Haven Homes</p>
  </div>
  ...
  <div style="border-top:1px solid ${BRAND.border};padding:20px 28px;text-align:center;font-size:12px;color:${BRAND.muted};">
    <p style="margin:0;">&copy; ${BRAND.year} Haven Homes. All rights reserved.</p>
...
export const getEmailVerificationTemplate = (name, verificationUrl) => wrap(
  ...
  `<p style="margin:0 0 20px;font-size:15px;">Hello <strong style="color:${BRAND.color};">${name}</strong>,</p>
  <p style="margin:0 0 24px;font-size:15px;">Thanks for signing up with Haven Homes! To complete your registration and start exploring properties, please verify your email address.</p>
  ...
  <p style="font-size:13px;color:${BRAND.muted};margin:16px 0 0;">If you didn't create an account with Haven Homes, you can safely ignore this email.</p>`
);
...
export const getPasswordResetTemplate = (resetUrl) => wrap(
  'Reset Your Password',
  `<p style="margin:0 0 20px;font-size:15px;">We received a request to reset your Haven Homes account password.</p>
...
export const getListingApprovedTemplate = (propertyTitle, propertyId) => wrap(
  ...
  <div style="background:#f0fdf4;border-left:3px solid #16a34a;padding:14px 16px;border-radius:6px;font-size:14px;color:#166534;margin-bottom:24px;">
    Your listing is now visible to all buyers and renters on Haven Homes.
  </div>
...
export const getUserSuspendedTemplate = (userName, days, reason, suspendedUntil) => wrap(
  ...
  <p style="margin:0 0 20px;font-size:15px;">Your Haven Homes account has been temporarily suspended for ${days} day${days > 1 ? 's' : ''}. During this period, you will not be able to access your account or post new listings.</p>
...
export const getUserBannedTemplate = (userName, reason) => wrap(
  ...
  <p style="margin:0 0 20px;font-size:15px;">After careful review, your Haven Homes account has been permanently banned due to violations of our terms of service.</p>
  ...
  <div style="background:#fef2f2;border-left:3px solid #dc2626;padding:14px 16px;border-radius:6px;font-size:14px;color:#991b1b;margin-bottom:24px;">
    ...
    • You can no longer access your Haven Homes account<br>
...
export const getUserReactivatedTemplate = (userName) => wrap(
  ...
  <p style="margin:0 0 20px;font-size:15px;">Great news! Your Haven Homes account has been reactivated and you now have full access to all platform features.</p>
  ...
  <div style="background:#f0fdf4;border-left:3px solid #16a34a;padding:14px 16px;border-radius:6px;font-size:14px;color:#166534;margin-bottom:24px;">
    ...
    • Access to all Haven Homes features
  </div>

  <p style="margin:20px 0;font-size:15px;">We're glad to have you back! You can now log in and resume using Haven Homes.</p>

  ${btn(BRAND.site + '/login', 'Log In to Your Account')}

  <p style="font-size:13px;color:${BRAND.muted};margin:0;">Thank you for being part of the Haven Homes community.</p>`
);
