...
# Haven Homes Backend Quick Setup Script
# This script helps you set up the Haven Homes backend quickly
...
# Header
print_header "🏠 Haven Homes Backend Setup"
print_header "============================"
echo ""
...
MONGO_URI=mongodb://localhost:27017/Haven Homes
