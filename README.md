<img src="https://capsule-render.vercel.app/api?type=waving&color=0:F97316,100:FB923C&height=220&section=header&text=Haven Homes&fontSize=80&fontColor=ffffff&fontAlignY=35&animation=fadeIn&desc=AI-Powered+Real+Estate+Platform&descAlignY=58&descSize=24" width="100%"/>

<div align="center">

  <img src="./frontend/Assets/Logo.svg" alt="Haven Homes Logo" height="80" />
...
[![Live Demo](https://img.shields.io/badge/%F0%9F%9A%80_Live_Demo-Haven Homes.vercel.app-4285F4?style=for-the-badge)](https://Haven Homes.vercel.app)
...
<div align="center">
  <img src="./Image/Home.png" alt="Haven Homes Homepage" width="100%" />
</div>
...
|     | Section                                          |
| :-: | :----------------------------------------------- |
| 🧠  | [Why Haven Homes?](#-why-Haven Homes)            |
...
Most real-estate aggregators show you generic listings. Haven Homes is different:

| Problem | Haven Homes Solution |
|---|---|
...
User's browser (localStorage)
  Haven Homes_github_key   = "ghp_xxx"
  Haven Homes_firecrawl_key = "fc-xxx"
         │
...
MONGO_URI=mongodb+srv://username:password@cluster.mongodb.net/Haven Homes?retryWrites=true&w=majority
JWT_SECRET=your_super_secure_jwt_secret_here  # Generate with: openssl rand -base64 32
ADMIN_EMAIL=admin@Haven Homes.com
...
### Live Deployments
- **🌐 Frontend**: [Haven Homes.vercel.app](https://Haven Homes.vercel.app/) (Vercel)
