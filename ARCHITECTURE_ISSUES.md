# Haven Homes - Architecture Issues Document

> **Project:** Real Estate Website (Haven Homes)
...
| App | URL |
|-----|-----|
| **Frontend** | https://Haven Homes.vercel.app |
...
|---------|-------|----------|
| Auth Token | `token` | `Haven Homes_token` |
| Admin Flag | `isAdmin` | N/A |
| User Data | N/A | `Haven Homes_user` |
...
- ✅ Service metadata (`Haven Homes-api`)
...
FRONTEND_URL=https://Haven Homes.vercel.app
ADMIN_URL=https://real-estate-website-admin-sage.vercel.app
WEBSITE_URL=https://Haven Homes.vercel.app
```
